...
class Program
{
    static async Task Main()
    {
        await Deployment.RunAsync(() =>
        {
            ...
            var aspStack = new AspStack();
            var appStack = new AppStack(vnetStack.subnetIds,aspStack.Ids, stStack.Ids, pdnszStack.Ids);
            var kvStack = new KvStack(vnetStack.subnetIds, pdnszStack.Ids);
